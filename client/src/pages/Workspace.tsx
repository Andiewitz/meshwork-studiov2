                                ...
                                <Panel position="top-right" className="m-5">
                                    ...
                                    >
                                        ...
                                        <Popover>
                                            ...
                                            <PopoverContent className="w-72 p-0 bg-[#121214]/95 backdrop-blur-2xl border border-white/[0.08] rounded-2xl shadow-[0_12px_48px_rgba(0,0,0,0.8)] z-[200]" side="bottom" align="end" sideOffset={8}>
                                                                    ...
                                                                    <div className="flex items-center gap-2.5 px-1.5 py-1.5 rounded-lg hover:bg-white/[0.03] transition-colors group">
                                                                        ...
                                                                        {canChangeThis ? (
                                                                            <Popover>
                                                                                ...
                                                                                <PopoverContent className="w-36 p-1 bg-[#1A1A1A]/95 backdrop-blur-2xl border border-white/[0.08] rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.8)] z-[300]" side="left" align="center" sideOffset={4}>
                                                                                    {isOwnerActor && (
                                                                                        <button
